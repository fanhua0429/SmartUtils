...
{
    CGRect frame = self.frame;
    frame.size.width = viewRight - frame.origin.x;
    self.frame = frame;
}
...
andReferenceIsSuperView:(BOOL)isReferenceSuperView {
    ...
    if (alignment & UIViewAlignmentLeft) {
        ...
        if (isReferenceSuperView) {
            newRect.origin.x =
            CGRectGetWidth(referenceRect) - (CGRectGetWidth(startingRect) + insets.right);
        } else {
    ...
    if (alignment & UIViewAlignmentTop) {
        ...
        if (isReferenceSuperView) {
            newRect.origin.y =
            CGRectGetHeight(referenceRect) - (CGRectGetHeight(startingRect) + insets.bottom);
        } else {
            newRect.origin.y =
            CGRectGetMaxY(referenceRect) - (CGRectGetHeight(startingRect) + insets.bottom);
        }
        ...
        if (isReferenceSuperView) {
            newRect.origin.y = ((CGRectGetHeight(referenceRect) - CGRectGetHeight(startingRect)) / 2.0f) +
            insets.top - insets.bottom;
        } else {
            newRect.origin.y = CGRectGetMinY(referenceRect) +
            ((CGRectGetHeight(referenceRect) - CGRectGetHeight(startingRect)) / 2.0f) +
            insets.top - insets.bottom;
        }
    }
...
- (void)centerAlignHorizontalForView:(UIView *)view offset:(CGFloat)offset {
    [self setFrame:CGRectRound(CGRectMake((CGRectGetWidth([view frame]) / 2.0f) -
                                          (CGRectGetWidth([self frame]) / 2.0f) + offset,
...
- (void)centerAlignVerticalForView:(UIView *)view offset:(CGFloat)offset {
    [self setFrame:CGRectRound(CGRectMake(CGRectGetMinX([self frame]),
                                          (CGRectGetHeight([view frame]) / 2.0f) -
                                          (CGRectGetHeight([self frame]) / 2.0f) + offset,
...
- (void)leftAlignForView:(UIView *)view offset:(CGFloat)offset {
    [self setFrame:CGRectRound(CGRectMake(CGRectGetMinX([view frame]) + offset, CGRectGetMinY([self frame]),
                                          CGRectGetWidth([self frame]), CGRectGetHeight([self frame])))];
}

- (void)rightAlignForView:(UIView *)view offset:(CGFloat)offset {
    [self setFrame:CGRectRound(CGRectMake(CGRectGetMaxX([view frame]) - CGRectGetWidth([self frame]) - offset,
                                          CGRectGetMinY([self frame]), CGRectGetWidth([self frame]),
                                          CGRectGetHeight([self frame])))];
}

- (void)topAlignForView:(UIView *)view offset:(CGFloat)offset {
    [self setFrame:CGRectRound(CGRectMake(CGRectGetMinX([self frame]), [view frame].origin.y + offset,
                                          CGRectGetWidth([self frame]), CGRectGetHeight([self frame])))];
}

- (void)bottomAlignForView:(UIView *)view offset:(CGFloat)offset {
    [self setFrame:CGRectRound(CGRectMake(CGRectGetMinX([self frame]),
                                          CGRectGetMaxY([view frame]) - CGRectGetHeight([self frame]) - offset,
                                          CGRectGetWidth([self frame]), CGRectGetHeight([self frame])))];
}
...
- (void)setFrameSize:(CGSize)size {
    [self setFrame:CGRectMake(CGRectGetMinX([self frame]), CGRectGetMinY([self frame]), size.width,
                              size.height)];
}

- (void)setFrameOriginY:(CGFloat)y {
    [self setFrame:CGRectMake(CGRectGetMinX([self frame]), y, CGRectGetWidth([self frame]),
                              CGRectGetHeight([self frame]))];
}

- (void)setFrameOriginX:(CGFloat)x {
    [self setFrame:CGRectMake(x, CGRectGetMinY([self frame]), CGRectGetWidth([self frame]),
                              CGRectGetHeight([self frame]))];
}

- (void)setFrameSizeWidth:(CGFloat)width {
    [self setFrame:CGRectMake(CGRectGetMinX([self frame]), CGRectGetMinY([self frame]), width,
                              CGRectGetHeight([self frame]))];
}
...
- (void)setFrameOriginYBelowView:(UIView *)view offset:(CGFloat)offset {
    ...
    [self setFrame:CGRectRound(CGRectMake(CGRectGetMinX(frame), CGRectGetMaxY(viewFrame) + offset,
...
- (void)setFrameOriginYAboveView:(UIView *)view offset:(CGFloat)offset {
    ...
    [self setFrame:CGRectRound(CGRectMake(CGRectGetMinX(frame),
                                          CGRectGetMinY(viewFrame) - CGRectGetHeight([self frame]) - offset,
                                          CGRectGetWidth(frame), CGRectGetHeight(frame)))];
}
...
- (void)setFrameOriginXRightOfView:(UIView *)view offset:(CGFloat)offset {
    ...
    [self setFrame:CGRectRound(CGRectMake(CGRectGetMaxX(viewFrame) + offset, CGRectGetMinY(frame),
                                          CGRectGetWidth(frame), CGRectGetHeight(frame)))];
}
...
- (void)setFrameOriginXLeftOfView:(UIView *)view offset:(CGFloat)offset {
    ...
    [self setFrame:CGRectRound(CGRectMake(CGRectGetMinX(viewFrame) - CGRectGetWidth(frame) - offset,
...
- (void)setVerticalFadeMaskWithTopOffset:(CGFloat)topOffset bottomOffset:(CGFloat)bottomOffset {
    ...
    [maskLayer setColors:@[
                           (id)[outerColor CGColor], (id)[innerColor CGColor], (id)[innerColor CGColor], (id)[outerColor CGColor]
                           ]];
    [maskLayer setLocations:@[@(0.0f), @(topOffset), @(1.0f - bottomOffset), @(1.0f)]];
...
- (void)setHorizontalFadeMaskWithLeftOffset:(CGFloat)leftOffset rightOffset:(CGFloat)rightOffset {
    ...
    [maskLayer setLocations:@[@(0.0f), @(leftOffset), @(1.0f - rightOffset), @(1.0f)]];
...
static inline UIImage *createRoundedCornerMask(CGRect rect, CGFloat radius_tl, CGFloat radius_tr,
    ...
    context = CGBitmapContextCreate(NULL, rect.size.width * scaleFactor, rect.size.height * scaleFactor,
                                    8, rect.size.width * scaleFactor * 4, colorSpace,
...
- (void)frameDidChange {
    [self performInDebug:^{
        ...
        NSLog(@"%@ <%@: %p; frame = %@>", nameOfVar(self), NSStringFromClass([self class]), self,
...
+ (UINib *)pa_nibWithBundle:(NSBundle *)bundle {
    return [UINib nibWithNibName:[self ID] bundle:bundle];
}
+ (instancetype)viewFromNib {
    return [[self nib] instantiateWithOwner:nil options:nil].firstObject;
}
+ (instancetype)viewFromNibWithBundle:(NSBundle *)bundle{
    return [[self pa_nibWithBundle:bundle] instantiateWithOwner:nil options:nil].firstObject;
}
